...
function RootNodeComponent({ data, selected }: NodeProps & { data: RootNodeData }) {
  ...
  return (
    ...
    >
      ...
      >
        <Brain className="w-20 h-20 text-fuchsia-100" style={{ filter: 'drop-shadow(0 0 16px rgba(168, 85, 247, 0.8))' }} />
        <span
          className="text-[27px] font-bold text-white tracking-wider text-center leading-tight mt-2"
